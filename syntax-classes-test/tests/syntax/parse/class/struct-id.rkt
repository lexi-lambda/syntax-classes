...
(describe "class struct-id"
  ...
  (describe "attribute field-sym"
    (it "includes all field symbols, including parent fields"
  ...
  (describe "attribute own-field-sym"
    (it "includes own field symbols, but not parent fields"
      (define-syntax struct-own-fields
        (syntax-parser [(_ id:struct-id)
                        #`'#,(datum (id.own-field-sym ...))]))
